    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מאי תור - MYTOUR משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'c45e20a2-acb0-46b2-b627-360f3e870d3e',
                    name: data.name || '',
                    email: data.email || '',
